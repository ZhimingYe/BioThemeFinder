---
title: "BioThemeFinder_Example"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{BioThemeFinder_Example}
...
可以使用`?`在每个函数前面看具体的帮助文档。
    ...
    data("LUAD_DEG")
    BTFdemo<-Create.newBioThemeFinder.ORAwithFC(Gene = rownames(LUAD_DEG),log2FC = LUAD_DEG$log2FoldChange,Pvalue =LUAD_DEG$padj,FCcutoff = 3,PvalueCutOff = 0.01,Species = "human", FromType="ENSEMBL")
